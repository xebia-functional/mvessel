...
public class SQLDroidPreparedStatement implements PreparedStatement {
  ...
  public SQLDroidPreparedStatement(String sql, SQLDroidConnection sqldroid, String autoGeneratedColumn) {
    this(sql, sqldroid);
  ...
  public ResultSet getGeneratedKeys() throws SQLException {
    closeResultSet();
    final String column = autoGeneratedColumn == null ? "" : autoGeneratedColumn;
    Cursor c = db.rawQuery(String.format("SELECT last_insert_rowid() %s", column), null);
    rs = new SQLDroidResultSet(c, new AndroidLogWrapper(android.util.Log.INFO, "scala-sqlite-droid"));
    return rs;
  }

...
class StatementResultSetWrapper(
  ...
  override def getMetaData: ResultSetMetaData = resultSet.getMetaData
  ...
  override def getArray(columnIndex: Int): Array = resultSet.getArray(columnIndex)

  override def getArray(columnLabel: String): Array = resultSet.getArray(columnLabel)
